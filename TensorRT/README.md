...
- common args: [link](https://docs.nvidia.com/tao/tao-toolkit/text/trtexec_integration/index.html)
- document home: [link](https://docs.nvidia.com/deeplearning/tensorrt/developer-guide/index.html#trtexec)

**Build instructions by Model**
...
**trtexec command line args - FULL LIST**
