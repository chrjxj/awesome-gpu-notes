...
// for CUDA 7.x, use the sync version
// use mask: https://stackoverflow.com/questions/50639194/shfl-down-and-shfl-down-sync-give-different-results
...
reduce4(T *g_idata, T *g_odata, unsigned int n)
{
    ...
    if ( tid < 32 )
    {
        ...
        {
            mySum += __shfl_down(0xFFFFFFFF, mySum, offset);
        }
    }
#else
